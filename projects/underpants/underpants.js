...
_.last = function(array, number) {
    ...
    return array;
    }else return array.slice(array.length-number, number.length);
...
*/
_.pluck = function(obj, prop) {
    var array = [];
    _.map(obj, function(i,e,a) {
   array.push(i[prop]);
   } ) 
return array;
}
...
_.contains = function(array, value) {
  let a= (_.indexOf(array , value) >= 0 ) ? true: false;
 return a;
} 
